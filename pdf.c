...
int pdf_count_pages(const char *filename)
{
    ...
    snprintf(gscommand, CMDLINE_MAX-1, "%s -dNODISPLAY -dNOSAFER -dNOPAUSE -q -c "
                             ...
                             int last)
{
    ...
    snprintf(gscommand, CMDLINE_MAX-1, "%s -q -dNOPAUSE -dBATCH -dSAFER -dNOINTERPOLATE -dNOMEDIAATTRS"
